...
function createDuplicateButton(bdo, user) {
  ...
  button.onclick = async (e) => {
    ...
    // Get environment config for duplication
    const config = typeof getEnvironmentConfigForBDO === 'function'
      ? getEnvironmentConfigForBDO()
      : { services: { fount: 'http://localhost:3006', bdo: 'http://localhost:3002' } };
