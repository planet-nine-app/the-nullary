...
// Environment configuration for postary
...
window.postaryEnv = {
  switch: (env) => {
    ...
    console.log(`🔄 postary environment switched to ${env}. Refresh app to apply changes.`);
  ...
  list: () => {
    console.log('🌍 Available environments for postary:');
